	...
	<div id="innertext">
		...
		if($LANG_TAG == 'es'){
			...
			<div>
				...
				<p>Este portal de datos se ha establecido para promover la colaboración... </p>
			</div>
			<?php
		}
		elseif($LANG_TAG == 'fr'){
			...
			<div>
				...
				<p>Ce portail de données a été créé pour promouvoir la collaboration... </p>
			</div>
			<?php
		}
		else{
			...
			<div>
				<h1>Welcome</h1>
				<p>This data portal has been established to promote collaborative research... </p>
			</div>
			<?php
		}
		?>
